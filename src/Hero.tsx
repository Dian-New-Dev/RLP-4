...
const Hero: React.FC = () => {
    return (
        <div className='px-0 lg:px-16 xl:px-32 2xl:px-64 flex flex-col items-end w-full justify-end sm:pl-0 md:pl-0 lg:pl-80 pt-32  md:pt-80 gap-5 origin-top-right scale-[1] 2xl:scale-[1.5]'>
