        ...
        <div id="D" className="relative w-full max-w-[1440px] font-roboto bg-sky-100 flex flex-col justify-center items-center p-16 gap-16">
            ...
            <div className="flex flex-col sm:flex-row lg:grid grid-cols-2 items-center justify-center gap-4">
                <div className="z-10 bg-gray-100/50 py-4 border w-full max-w-[500px] flex flex-col items-center flex-1 justify-center text-center gap-2 hover:scale-[1.01]">
                    <img className="w-28 rounded-full border border-gray-400/50 p-1" src="images/img (1).png" alt="Foto de rosto de usuário do aplicativo" />
                ...
                <div className="z-10 bg-gray-100/50 py-4 border w-full max-w-[500px] flex flex-col items-center flex-1 justify-center text-center gap-2 hover:scale-[1.01]">
                    <img className="w-28 rounded-full border border-gray-400/50 p-1" src="images/img (1).jpeg" alt="Foto de rosto de usuário do aplicativo" />
                ...
                <div className="z-10 bg-gray-100/50 py-4 border w-full max-w-[500px] flex flex-col items-center flex-1 justify-center text-center gap-2 hover:scale-[1.01]">
                    <img className="w-28 rounded-full border border-gray-400/50 p-1" src="images/img (2).jpeg" alt="Foto de rosto de usuário do aplicativo" />
                ...
                <div className="z-10 bg-gray-100/50 py-4 border w-full max-w-[500px] flex flex-col items-center flex-1 justify-center text-center gap-2 hover:scale-[1.01]">
                    <img className="w-28 rounded-full border border-gray-400/50 p-1" src="images/img (3).jpeg" alt="Foto de rosto de usuário do aplicativo" />
            ...
            <img className="absolute z-0 w-96 opacity-50 left-0 top-0" src="images/depo1.png" alt="Desenho de pessoa correndo" />
            <img className="absolute z-0 w-96 opacity-50 right-0 bottom-0" src="images/depo2.png" alt="Desenho de pessoa correndo" />
        </div>
    )
}
